using System;
using BcEjercicioClasePolimorfismoCasaMusical;
namespace ejercicioClasePolimorfismoCasaMusical
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Trompeta otraTrompetita = new Trompeta(75, "Csa", Instrumento.EClasificacion.Vientos, "9");
            ...
            if (unaCasitaDeMusica + otraTrompetita)
            {
                Console.WriteLine("Se agrego con exito");
            }
            else
            ...
            Console.WriteLine(unaCasitaDeMusica.ToString());
            Console.WriteLine("-----------------------------------------------------------------------------------------");
