...
namespace BcExcepcionGoSpeedRacerGo
{
    public class Competencia
    {
        ...
        public static bool operator ==(Competencia unaCompetencia, VehiculoDeCarrera unVehiculo)
        {
            ...
            {
                throw new CompetenciaNoDisponibleException("El vehículo no corresponde a la competencia", "Competencia", "Sobrecarga del operador ==");
            }
        ...
        public static bool operator +(Competencia compe, VehiculoDeCarrera unVehiculo)
        {
            ...
            if (compe.competidores.Count < compe.cantidadCompetidores)
            {
                ...
                catch (CompetenciaNoDisponibleException ex)
                {
                    ...
                    throw new CompetenciaNoDisponibleException("Competencia incorrecta", "Competencia", "Sobrecarga operador +", ex);
                }
            }
